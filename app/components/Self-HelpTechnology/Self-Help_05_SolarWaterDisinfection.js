            ...
            <form className="form-group">
              <div className="row">
                <div className="col-md-6">
                  <img src="/static/images/Self-HelpTechnology/Solar_Water_Disinfection_01.jpg" />
                </div>
                <div className="col-md-6">
                  <img src="/static/images/Self-HelpTechnology/Solar_Water_Disinfection_03.jpg" />
                </div>
              </div>
            </form>

            <form className="form-group">
              <img src="/static/images/Self-HelpTechnology/Solar_Water_Disinfection_02.jpg" />
            </form>
